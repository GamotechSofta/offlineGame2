...
const BetsByUser = () => {
    ...
    const getStatusBadgeClass = (status) => {
        switch (status) {
            ...
            case 'pending':
                return 'bg-sb-primary/10 text-sb-primary border-sb-primary/20';
            case 'cancelled':
                    ...
                    <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-sb-primary focus:border-transparent"
                            />
                        </div>
                    </div>
                                            ...
                                            <tr key={player._id} className="hover:bg-gray-50 transition-colors">
                                                ...
                                                <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                                                    <button
                                                        ...
                                                        className="px-4 py-2 bg-sb-primary hover:bg-sb-primary-dark text-white rounded-lg transition-colors text-sm font-medium"
                                                    >
                                                        {t('viewBets')}
                                                    </button>
                                                </td>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-sb-primary focus:border-transparent text-sm"
                            />
                        </div>
                        <div>
                            <label className="block text-xs font-medium text-gray-700 mb-1">
                ...
                {!betsLoading && bets.length > 0 && (
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
                            ...
                            <p className="text-2xl font-bold text-sb-primary">
