                ...
                <div className="min-w-0 max-w-full space-y-5 print:space-y-0">
                    ...
                    <div className="print:hidden">
                        <button
                            ...
                            className="text-gray-400 hover:text-sb-primary text-sm inline-flex items-center gap-1 mb-1"
                        >
                        ...
                        <div className="p-6 max-w-3xl mx-auto print:p-0 print:max-w-none receipt-container print:m-0">
                            ...
                            <div className="border-2 border-gray-300 rounded-lg p-3 print:border-gray-800 print:rounded-none print:p-2">
                                        ...
                                        <div className="flex flex-wrap justify-between gap-x-3">
                                            ...
                                            {marketDetails.openingNumber && marketDetails.closingNumber && (
                                                <span>
                                                    ...
                                                    <span className="font-mono font-bold text-sb-primary ml-1">
                                ...
                                <div className="mb-1.5 pt-1.5 border-t border-gray-300">
                                    ...
                                    <div className="flex justify-between items-center py-0.5 text-[10px] print:text-[9px]">
                                        <div className="flex items-center gap-1.5">
                                            ...
                                            <button
                                                ...
                                                className="text-sb-primary hover:text-sb-primary-dark text-[9px] font-medium underline print:hidden disabled:opacity-50"
                                            >
                                    ...
                                    <div className="mt-1 pt-1 border-t-2 border-sb-primary/40 flex justify-between items-center py-1 bg-sb-primary/5 print:bg-transparent">
                                        <span className="text-gray-800 font-bold text-xs print:text-[10px]">FINAL TOTAL:</span>
                                        <span className="font-mono font-bold text-base text-sb-primary print:text-sm">{formatCurrency(finalTotal)}</span>
                                    </div>
                                </div>
            ...
            <Layout title={t('receipt')}>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4 sm:mb-6">
                    <h1 className="text-2xl sm:text-3xl font-bold flex items-center gap-2">
                        <FaFileInvoiceDollar className="text-sb-primary" />
                        {t('receipts')}
                    </h1>
                </div>
                ...
                <div className="mb-4 sm:mb-6">
                    <div className="relative max-w-md">
                        ...
                        <input
                            ...
                            className={`w-full pl-10 py-2.5 bg-gray-100/80 border border-gray-200 rounded-xl text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-sb-primary/50 focus:border-sb-primary transition-all text-sm sm:text-base ${searchQuery ? 'pr-10' : 'pr-4'}`}
                        />
                        {searchQuery && (
                            <button
                                type="button"
                ...
                <div className="bg-white rounded-lg overflow-x-auto overflow-y-hidden border border-gray-200 min-w-0 max-w-full">
                    {loading ? (
                        <div className="p-8 text-center">
                            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-sb-primary mx-auto" />
                                        ...
                                        {filteredPlayers.map((player, index) => (
                                            <tr key={player._id} className="hover:bg-gray-50">
                                                ...
                                                <td className="px-2 sm:px-3 py-2 sm:py-3 font-medium">
                                                    <span className="text-sb-primary truncate block max-w-[200px]">{player.username}</span>
                                                </td>
                                                ...
                                                <td className="px-2 sm:px-3 py-2 sm:py-3">
                                                    <button
                                                        ...
                                                        className="inline-flex items-center gap-1 px-2 py-1.5 rounded-lg bg-sb-primary hover:bg-sb-primary-dark text-white text-xs font-semibold transition-colors"
                                                        title="View receipts"
                                                    >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4 sm:mb-6">
                <div>
                    <button
                        ...
                        className="text-gray-400 hover:text-sb-primary text-sm inline-flex items-center gap-1 mb-2"
                    >
                        ...
                        <div className="absolute left-0 top-full mt-2 py-3 rounded-xl bg-white border border-gray-200 shadow-xl z-50 flex flex-col sm:flex-row gap-4 max-w-[100vw]">
                            ...
                            <div className="border-t sm:border-t-0 sm:border-l border-gray-200 pt-3 sm:pt-0 sm:pl-4 pr-4 min-w-0 sm:min-w-[200px]">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <button type="button" onClick={handleDateApply} className="w-full py-2 rounded-lg bg-sb-primary text-white font-semibold hover:bg-sb-primary-dark text-sm">
                                        Apply
                                    </button>
                                </div>
                            </div>
                                        ...
                                        <tr key={session.sessionId} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-2 sm:px-3 py-2 sm:py-3 text-xs">
                                                <span className={`px-2 py-0.5 rounded-full font-semibold ${
                                                    summary.isResultReady ? 'bg-green-100 text-green-700' : 'bg-sb-primary/10 text-sb-primary'
                                                }`}>
