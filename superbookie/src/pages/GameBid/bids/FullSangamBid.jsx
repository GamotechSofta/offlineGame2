                    ...
                    <div className="flex flex-col gap-3">
                        <div className="flex flex-row items-center gap-2">
                            ...
                            <input type="text" inputMode="numeric" value={openPana}
                                ...
                                placeholder="Pana"
                                className={`flex-1 min-w-0 bg-gray-100 border border-gray-200 text-gray-800 placeholder-gray-400 rounded-full py-2.5 min-h-[40px] px-4 text-center text-sm focus:ring-2 focus:outline-none ${openPanaInvalid ? 'border-red-500 focus:border-red-500 focus:ring-red-500/20' : 'focus:ring-sb-primary focus:border-sb-primary'}`} />
                        </div>
                        <div className="flex flex-row items-center gap-2">
                            ...
                            <input type="text" inputMode="numeric" value={closePana}
                                ...
                                placeholder="Pana"
                                className={`flex-1 min-w-0 bg-gray-100 border border-gray-200 text-gray-800 placeholder-gray-400 rounded-full py-2.5 min-h-[40px] px-4 text-center text-sm focus:ring-2 focus:outline-none ${closePanaInvalid ? 'border-red-500 focus:border-red-500 focus:ring-red-500/20' : 'focus:ring-sb-primary focus:border-sb-primary'}`} />
                        </div>
                        <div className="flex flex-row items-center gap-2">
