    ...
    return (
        ...
        >
            <div className="px-3 py-2 w-full max-w-full overflow-x-hidden">
                ...
                <div className="flex flex-col md:grid md:grid-cols-2 md:gap-6 md:items-center gap-3 w-full">
                    <div className="w-full min-w-0 md:flex md:justify-center md:items-center">
                        <div className="flex flex-col gap-2 mb-1 md:mb-0 w-full md:max-w-sm">
                            <div className="rounded-xl border border-gray-300 bg-white p-3">
                                <div className="text-[11px] text-gray-500 font-medium mb-2">Selected Date</div>
                                <div className="rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-xs font-semibold text-gray-800 text-center">
                                    {todayDate}
                                </div>
                                <div className="text-[11px] text-gray-500 font-medium mt-3 mb-2">Play Type</div>
                            ...
                            <div className="flex flex-row items-center gap-2 mt-1">
                                <label className="text-gray-600 text-xs font-medium shrink-0 w-24">Enter Points:</label>
                                <input
                                    type="text"
                                    inputMode="numeric"
                                    value={inputPoints}
                                    ...
                                    placeholder="Point"
                                    className="no-spinner flex-1 min-w-0 bg-white border-2 border-gray-300 text-gray-800 placeholder-gray-500 rounded-full py-2 min-h-[36px] px-4 text-center text-xs font-semibold focus:ring-2 focus:ring-gray-400 focus:border-gray-400 focus:outline-none"
                                />
                            </div>
                            <p className="text-[11px] text-gray-500">Tip: enter points once, then tap digits to add quickly.</p>
                        </div>
                    </div>
