                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="flex flex-row items-center gap-2">
                            ...
                            <input type="text" inputMode="numeric" value={closeAnk} onChange={(e) => setCloseAnk(sanitizeDigits(e.target.value, 1))} placeholder="Ank"
                                className="flex-1 min-w-0 bg-gray-100 border border-gray-200 text-gray-800 placeholder-gray-400 rounded-full py-2.5 min-h-[40px] px-4 text-center text-sm focus:ring-2 focus:ring-sb-primary focus:border-sb-primary focus:outline-none" />
                        </div>
                        <div className="flex flex-row items-center gap-2">
