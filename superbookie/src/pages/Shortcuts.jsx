        ...
        <Layout title={t('shortcuts')}>
            <div className="max-w-4xl mx-auto p-4 sm:p-6">
                <div className="bg-white rounded-xl border border-gray-200 shadow-lg overflow-hidden">
                    {/* Header */}
                    <div className="bg-gradient-to-r from-sb-primary to-sb-primary-darker p-6 text-white">
                        ...
                        {shortcuts.map((category, catIdx) => (
                            <div key={catIdx} className="border-b border-gray-200 last:border-b-0 pb-6 last:pb-0">
                                <h2 className="text-xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                                    <span className="w-1 h-6 bg-sb-primary rounded-full" />
                                    {category.category}
                                </h2>
                                <div className="space-y-3">
                                    {category.items.map((item, itemIdx) => (
                                        <div
                                            key={itemIdx}
                                            className="flex items-start gap-4 p-4 rounded-lg bg-gray-50 hover:bg-sb-primary-dark/5 transition-colors border border-gray-100"
                                        >
                                            {item.icon && (
                                                <div className="mt-1 text-sb-primary">
