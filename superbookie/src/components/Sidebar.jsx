...
const Sidebar = ({ user, onLogout, isOpen = true, onClose }) => {
    ...
    const menuItems = [
        ...
        { path: '/super-bookies', label: t('bookies'), icon: FaUsersCog, key: 'superBookies' },
        ...
        { path: '/commission', label: t('commissionSuperBookies'), icon: FaMoneyBillWave, key: 'commission' },
        { path: '/commission-from-admin', label: t('commissionFromAdmin'), icon: FaMoneyBillWave, key: 'commissionFromAdmin' },
