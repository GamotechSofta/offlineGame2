...
export default function SpDpMotorBid({ market, title }) {
        ...
        <View style={[styles.twoColRow, isNarrow && styles.twoColRowStack]}>
          ...
          <View style={[styles.tableWrap, isNarrow && styles.tableWrapFull]}>
            <View style={styles.tableHeader}>
              <View style={styles.tableHeaderPana}>
                ...
                combinations.map((c) => (
                  <View key={c.id} style={styles.tableRow}>
                    ...
                    <View style={styles.typeCell}>
                      <Text style={styles.typeText}>{c.kind === 'DP' ? 'DP' : 'SP'}</Text>
                    </View>
...
const styles = StyleSheet.create({
  ...
  tableHeaderPana: { width: 72, alignItems: 'center' },
  tableHeaderType: { width: 56, alignItems: 'center' },
  ...
  typeCell: { width: 56, alignItems: 'center' },
