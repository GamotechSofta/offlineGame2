...
export const BID_TYPES = {
  ...
  JODI_BULK: { key: 'jodi', label: 'Jodi Bulk', digitCount: 2, hasSpecialMode: false },
  SINGLE_PANA: { key: 'panna', label: 'Single Pana', digitCount: 3, hasSpecialMode: false },
  SINGLE_PANA_BULK: { key: 'panna', label: 'Single Pana Bulk', digitCount: 3, hasSpecialMode: false },
  DOUBLE_PANA: { key: 'panna', label: 'Double Pana', digitCount: 3, hasSpecialMode: false },
  DOUBLE_PANA_BULK: { key: 'panna', label: 'Double Pana Bulk', digitCount: 3, hasSpecialMode: false },
  TRIPLE_PANA: { key: 'panna', label: 'Triple Pana', digitCount: 3, hasSpecialMode: false },
  FULL_SANGAM: { key: 'full-sangam', label: 'Full Sangam', hasSpecialMode: false },
  HALF_SANGAM: { key: 'half-sangam', label: 'Half Sangam', hasSpecialMode: false },
};
