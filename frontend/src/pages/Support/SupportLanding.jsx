    ...
    <div className="min-h-screen bg-gray-100 text-gray-800 px-3 sm:px-6 md:px-8 pb-[calc(6rem+env(safe-area-inset-bottom,0px))]">
      <div className="w-full max-w-xl mx-auto">
        <div className="flex items-center gap-3 pt-4 pb-3">
          ...
          <h1 className="text-xl sm:text-2xl font-semibold text-[#1B3150]">Help Desk</h1>
        </div>
        <p className="text-gray-600 text-sm sm:text-base mb-8">Choose an option below.</p>

        <div className="space-y-4">
          <button
            type="button"
            onClick={() => navigate('/support/new')}
            className="w-full bg-white rounded-2xl border-2 border-gray-200 p-5 shadow-sm text-left flex items-center gap-4 hover:border-[#1B3150] hover:shadow-md transition"
          >
            <div className="w-12 h-12 rounded-xl bg-[#1B3150]/10 flex items-center justify-center shrink-0">
            ...
            <div className="min-w-0 flex-1">
              <h2 className="font-semibold text-gray-800 text-lg">Raise help ticket</h2>
              <p className="text-sm text-gray-500 mt-0.5">Submit a new problem with description and screenshots.</p>
            </div>
            <svg className="w-5 h-5 text-[#1B3150] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <h2 className="font-semibold text-gray-800 text-lg">Check previous problem status</h2>
              <p className="text-sm text-gray-500 mt-0.5">See status and reply for your submitted tickets.</p>
            </div>
            <svg className="w-5 h-5 text-[#1B3150] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
            </svg>
