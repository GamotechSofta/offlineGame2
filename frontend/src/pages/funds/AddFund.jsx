                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <label
                                    ...
                                    className="block w-full h-40 bg-gray-50 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer hover:border-gray-400 transition-colors overflow-hidden"
                                >
                                    {screenshotPreview ? (
                                ...
                                {screenshotPreview ? (
                                    <div className="mt-2 flex justify-end">
                                        <label
                                            htmlFor="screenshot-upload"
                                            className="inline-flex items-center px-3 py-1.5 rounded-lg border-2 border-gray-300 bg-white text-xs font-semibold text-gray-700 cursor-pointer hover:border-gray-400"
                                        >
                                            Change Screenshot
                                        </label>
                                    </div>
