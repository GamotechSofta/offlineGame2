    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-green-900/40 to-green-800/30 rounded-2xl p-5 border border-green-500/30">
                <h3 className="text-lg font-bold text-green-400 mb-4">Payment Details</h3>
                        ...
                        {config?.upiId ? (
                            <img
                                src={`https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=${encodeURIComponent(
                                    `upi://pay?pa=${config.upiId}&pn=${encodeURIComponent(config.upiName || 'Golden Games')}&cu=INR`
                                )}`}
                                alt="UPI QR Code"
                ...
                <div className="space-y-3">
                    ...
                    <div className="text-center text-gray-400 text-sm">
                        Min: ₹{config?.minDeposit || 100} | Max: ₹{config?.maxDeposit || 50000}
                    </div>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                    ...
                    <input
                        ...
                        className="w-full bg-[#1a1a1a] border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-green-500"
                        min={config?.minDeposit || 100}
                        max={config?.maxDeposit || 50000}
                    />
                ...
                <div>
                    <label className="block text-gray-300 text-sm font-medium mb-2">
                        UTR / Transaction ID <span className="text-gray-500">(Optional)</span>
                    </label>
                    <input
                        type="text"
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <label
                            ...
                            className="flex flex-col items-center justify-center w-full h-40 bg-[#1a1a1a] border-2 border-dashed border-white/20 rounded-xl cursor-pointer hover:border-green-500/50 transition-colors"
                        >
                            {screenshotPreview ? (
                                <img
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className="w-full py-4 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-bold rounded-xl transition-all disabled:opacity-50"
                >
