      ...
      <div className="p-3 sm:p-4 pb-24 md:pb-6 sm:pb-8 min-h-0">
        ...
        <div className="flex flex-col md:flex-row gap-4 sm:gap-5 items-stretch md:items-start">
          <div className="flex flex-col gap-3 w-full md:w-1/2 shrink-0 min-w-0">
            ...
            {/* Desktop: inline Bets / Points / SUBMIT */}
          ...
          <div className="w-full md:w-1/2 flex-1 min-w-0 rounded-lg border border-gray-200 overflow-hidden flex flex-col min-h-[200px] sm:min-h-[260px]">
            <div className="overflow-x-auto shrink-0">
              <div className="grid grid-cols-[minmax(64px,72px)_1fr_minmax(44px,48px)] sm:grid-cols-[72px_1fr_48px] gap-2 bg-[#1B3150] text-white font-bold text-xs sm:text-sm py-2.5 px-2 sm:px-3 min-w-0">
                <div className="text-center">Sp Motar</div>
              ...
              {combinations.length === 0 ? (
                ...
                <div className="min-w-0">
                  {combinations.map((c) => (
                    <div
                      key={c.id}
                      className="grid grid-cols-[minmax(64px,72px)_1fr_minmax(44px,48px)] sm:grid-cols-[72px_1fr_48px] gap-2 items-center py-2.5 px-2 sm:px-3 border-b border-gray-200 min-h-[44px]"
                    >
        ...
        {/* Mobile only: sticky compact bar above bottom nav */}
        <div
