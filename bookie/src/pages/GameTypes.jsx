                ...
                <div className="min-h-screen bg-white flex flex-col items-center">
                    ...
                    <div className="w-full flex items-center px-3 sm:px-4 pt-4 sm:pt-5 pb-3 sm:pb-4 bg-white border-b border-gray-200 relative">
                        ...
                        <div className="w-full text-center pr-12 pl-12 min-w-0">
                            {loading ? (
                                ...
                                <>
                                    <h1 className="text-gray-800 font-bold text-base sm:text-lg tracking-wider uppercase inline-block border-b-2 border-sb-primary pb-1 px-2 py-1 truncate max-w-full">
                                    ...
                                    <div className="mt-1 flex items-center justify-center gap-3 text-xs text-gray-400">
                                        ...
                                        <span className="text-sb-primary font-mono font-bold">{market.displayResult || '***-**-***'}</span>
                                    </div>
                                </>
                            ) : (
                    ...
                    {loading ? (
                        <div className="flex items-center justify-center py-16">
                            <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-sb-primary"></div>
                        </div>
                    ) : !market ? (
                        <div className="text-center py-12">
                            ...
                            <button
                                ...
                                className="mt-3 text-sb-primary hover:underline text-sm"
                            >
                                Go back to markets
                            </button>
                        </div>
                        ...
                        <div className="w-full max-w-md lg:max-w-none px-3 sm:px-4 pt-3 sm:pt-4 pb-6 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 sm:gap-4">
                            {visibleOptions.map((option) => (
                                <div
                                    ...
                                    className="relative rounded-2xl bg-white border-2 border-gray-100 p-3.5 sm:p-4 flex flex-col items-center justify-center gap-2 sm:gap-2.5 hover:border-sb-primary/40 hover:shadow-lg hover:shadow-sb-primary/15 active:scale-[0.97] transition-all cursor-pointer group touch-manipulation min-h-[104px] sm:min-h-[120px] md:min-h-[132px] shadow-sm"
                                >
                                    {/* Icon Container */}
                                    ...
                                    {/* Title */}
                                    <span className="text-gray-700 group-hover:text-sb-primary text-[10px] sm:text-[11px] md:text-sm font-bold tracking-[0.12em] sm:tracking-[0.15em] uppercase text-center line-clamp-2 leading-tight transition-colors">
                                        {option.title}
                                    </span>
                                </div>
                            ))}
