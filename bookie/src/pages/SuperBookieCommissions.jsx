            ...
            <div className="space-y-4 sm:space-y-5">
                ...
                <div className="flex flex-wrap gap-2">
                    {[
                        ...
                        { id: 'requests', label: `Commission Requests (${pendingRequestCount})` },
                    ].map((tab) => (
                        <button
                            key={tab.id}
                            type="button"
                ...
                {pageTab === 'requests' && (
                    <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm">
                        <div className="px-4 py-3 border-b bg-slate-50">
                            ...
                            <p className="text-xs text-slate-500 mt-1">Approve, reject, or counter offer — same as admin bookie flow.</p>
                        </div>
                        {requests.length === 0 ? (
                                    ...
                                    <div key={req._id} className="p-4 flex flex-wrap justify-between gap-3">
                                        ...
                                        {req.status === 'pending' && (
                                            <div className="flex gap-2">
                                                ...
                                                <button type="button" onClick={() => setNegotiateModal({ open: true, requestId: req._id, counterOffer: String(req.requestedPercentage), message: '' })} className="px-3 py-1.5 bg-blue-600 text-white rounded-lg text-xs">Counter</button>
                    ...
                    <div className="bg-white rounded-xl w-full max-w-md p-4">
                        ...
                        <form onSubmit={submitNegotiate} className="space-y-3">
                            ...
                            <div className="flex gap-2">
                                ...
                                <button type="submit" className="flex-1 py-2 bg-blue-600 text-white rounded-lg">Send</button>
                            </div>
                        </form>
                    </div>
                </div>
...
export default SuperBookieCommissions;
