...
const cardBase =
    ...
    'hover:border-sb-primary/30 hover:bg-sb-primary-dark/5 active:scale-[0.995] ' +
    'focus-visible:ring-2 focus-visible:ring-sb-primary/40 focus-visible:ring-offset-2';

const cardSelected = 'border-sb-primary bg-sb-primary/5 shadow-sm shadow-sb-primary/10';
        ...
        >
            <div
                className={`mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full border-2 transition-all duration-200 pointer-events-none ${
                    isSelected ? 'border-sb-primary bg-sb-primary' : 'border-gray-300 bg-white'
                }`}
                aria-hidden
            >
            ...
            <div className="min-w-0 flex-1 pointer-events-none">
                <div className="flex items-center gap-2 font-semibold text-gray-800">
                    <Icon className={`h-5 w-5 shrink-0 ${isSelected ? 'text-sb-primary' : 'text-gray-400'}`} />
                    {title}
                </div>
