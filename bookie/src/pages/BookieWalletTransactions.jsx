...
const BookieWalletTransactions = () => {
    const { t } = useLanguage();
    ...
    const [operatorRole, setOperatorRole] = useState('super_bookie');
    ...
    const categories = [
        { id: 'from_bookie', label: t('walletTxFromBookie'), icon: FaMoneyBillWave },
        { id: 'from_player', label: t('walletTxFromPlayer'), icon: FaUsers },
        { id: 'all', label: t('walletTxAll'), icon: FaList },
    ];

    const emptyMsg =
        category === 'from_bookie'
            ? t('walletTxEmptyBookie')
...
export default BookieWalletTransactions;
