                        ...
                        winners.map((winner, i) => (
                            <div key={winner._id} className="bg-white rounded-lg p-4 sm:p-6 border border-gray-200">
                                <div className="flex items-center gap-3 mb-4">
                                    <div className={`w-12 h-12 rounded-full flex items-center justify-center text-xl font-bold ${i === 0 ? 'bg-sb-primary text-white' : i === 1 ? 'bg-gray-400 text-gray-800' : i === 2 ? 'bg-sb-primary-dark text-white' : 'bg-gray-100 text-gray-800'}`}>{i + 1}</div>
                                    <div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex justify-between"><span className="text-gray-400">Total Winnings:</span><span className="font-semibold text-sb-primary">₹{winner.totalWinnings}</span></div>
