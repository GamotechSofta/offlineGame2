            ...
            <div className="space-y-4 sm:space-y-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 flex items-center gap-3">
                            <span className="w-10 h-10 rounded-xl bg-sb-primary/20 flex items-center justify-center">
                                <FaMoneyBillWave className="w-5 h-5 text-sb-primary" />
                            </span>
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gray-100 hover:bg-sb-primary-dark/20 border border-gray-200 hover:border-sb-primary/30 text-gray-600 hover:text-sb-primary transition-all disabled:opacity-60 text-sm font-medium"
                    >
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-6 space-y-4">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-sb-primary/50 focus:border-sb-primary transition-all text-sm sm:text-base"
                        />
                        {searchQuery && (
                            <button
                                type="button"
                    ...
                    <div className="flex flex-wrap items-center gap-3 pt-2 border-t border-gray-200">
                        <button
                            ...
                            className="inline-flex items-center gap-2 px-4 py-2.5 bg-sb-primary hover:bg-sb-primary-dark disabled:bg-gray-300 disabled:cursor-not-allowed text-white rounded-xl font-medium transition-colors text-sm shadow-sm hover:shadow-md"
                        >
                                ...
                                <tbody className="divide-y divide-gray-100">
                                    {filteredCustomers.map((customer) => {
                                        ...
                                        return (
                                            <tr 
                                                key={customer.userId} 
                                                className={`hover:bg-sb-primary-dark/5 transition-colors ${isEditing ? 'bg-sb-primary/5' : ''}`}
                                            >
                                                    ...
                                                    {isEditing ? (
                                                        <div className="flex justify-end">
                                                            <input
                                                                ...
                                                                className="w-28 px-3 py-2 border-2 border-sb-primary/30 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-sb-primary focus:border-sb-primary font-mono"
                                                                disabled={updating}
                                                                autoFocus
                                                            />
                                                        </div>
                                                ...
                                                <td className="px-4 py-4">
                                                    {isEditing ? (
                                                        <div className="flex items-center justify-center gap-2">
                                                            ...
                                                            {updating && (
                                                                <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-sb-primary"></div>
                                                            )}
                        </div>
                                                    ) : (
                                                        <div className="flex items-center justify-center gap-2">
                                                            <button
                                                                ...
                                                                className="p-2 text-sb-primary hover:text-white hover:bg-sb-primary-dark rounded-lg transition-all shadow-sm hover:shadow-md"
                                                                title={t('edit')}
                                                            >
