        ...
        >
            <div className="p-4 sm:p-6 border-b border-violet-100 shrink-0 flex items-center justify-between bg-gradient-to-br from-violet-50 to-white">
                <div>
                    ...
                    <div className="mt-2 inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-violet-50 border border-violet-100">
                        <FaWallet className="w-3.5 h-3.5 text-violet-600 shrink-0" />
                        <span className="text-[10px] uppercase tracking-wide text-violet-700/80 font-medium">
                            {t('walletBalance')}
                        </span>
