...
const Sidebar = ({ user, onLogout, isOpen = true, onClose }) => {
    ...
    const menuItems = [
        ...
        { path: '/super-bookies', label: 'Super Bookies', icon: FaUsersCog, key: 'superBookies' },
        ...
        { path: '/super-bookie-commissions', label: 'Super Bookie Commissions', icon: FaMoneyBillWave, key: 'sbCommissions' },
