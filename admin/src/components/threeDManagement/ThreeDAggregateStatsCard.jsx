...
const ThreeDAggregateStatsCard = ({
    data,
    loading,
    error,
    appliedFrom,
    ...
    return (
        <div className="bg-white border border-gray-200 rounded-xl p-5">
            <div className="flex flex-wrap items-start justify-between gap-3">
                <div>
                    <h3 className="text-lg font-semibold text-gray-800">3D Overall Statistics</h3>
            ...
            {loading ? (
                ...
                <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                    <StatCell label="Total 3D tickets" value={Number(data?.total3DTickets ?? 0).toLocaleString('en-IN')} />
                    ...
                    <StatCell label="Unique users 3D game" value={Number(data?.uniqueUsers3D ?? 0).toLocaleString('en-IN')} />
...
export default ThreeDAggregateStatsCard;
