...
import { 
    ...
    getAdminSuperBookieCommissionDashboard,
    updateBookie,
    deleteBookie,
    toggleBookieStatus,
...
router.post('/lottery2d/slots/details-batch', verifyAdmin, getLottery2DSlotDetailsBatch);
...
router.get('/lottery3d/aggregate-stats', verifyAdmin, getLottery3DAggregateStats);
...
router.get(
    '/bookies/:id/super-bookies/:superBookieId/commission-dashboard',
    verifyAdmin,
    getAdminSuperBookieCommissionDashboard,
);
